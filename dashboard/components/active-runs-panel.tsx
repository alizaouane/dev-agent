 ...
 * doesn't waste space on completed features.
 */
export function ActiveRunsPanel({ runs }: { runs: ActiveRun[] }) {
    ...
    <Card>
      ...
      <CardContent className="flex flex-col gap-2">
        {runs.map((r) => (
          <div
            key={r.id}
            className="flex flex-wrap items-center gap-3 rounded-md border border-blue-500/40 bg-blue-500/10 px-3 py-2 text-sm"
          >
